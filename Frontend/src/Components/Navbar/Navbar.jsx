                ...
                return (
                    <>
                        ...
                        {roles && roles.filter(value => value.roleCode === 'ADMIN').length > 0 &&
                            <li className="nav-item mx-2">
                                <NavLink to="/Admin" aria-current="page" className={({ isActive }) => (isActive ? 'active btn btn-success' : 'inactive btn btn-success')} end>Add Product</NavLink>
                            </li>
                        }
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg bg-light sticky-top" >
            ...
            <div className="container-fluid">
                <a className="navbar-brand fw-bold text-secondary" href="#">TrendyThreads</a>
